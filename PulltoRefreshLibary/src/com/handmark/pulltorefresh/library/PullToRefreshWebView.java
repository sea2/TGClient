...
public class PullToRefreshWebView extends PullToRefreshBase<WebView> {
    ...
    protected boolean isReadyForPullEnd() {
        double exactContentHeight = Math.sqrt(mRefreshableView.getContentHeight() * mRefreshableView.getScale());
    ...
    final class InternalWebViewSDK9 extends WebView {
        ...
        private int getScrollRange() {
            return (int) Math.max(0, Math.sqrt(mRefreshableView.getContentHeight() * mRefreshableView.getScale()) - (getHeight() - getPaddingBottom() - getPaddingTop()));
        }
    }
}
