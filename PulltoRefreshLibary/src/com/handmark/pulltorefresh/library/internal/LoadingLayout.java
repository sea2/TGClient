...
public abstract class LoadingLayout extends FrameLayout implements
    ...
    protected Drawable imageDrawable = null;
    ...
    public final void setHeaderBg(String colorNum) {
      ...
      {
        mInnerLayout.setBackgroundColor(Color.parseColor(colorNum));
      }
    }

    public final void setHeaderTextColor(String colorNum) {
        if (null != mHeaderText) {
            mHeaderText.setTextColor(Color.parseColor(colorNum));
        }
        if (null != mSubHeaderText) {
            mSubHeaderText.setTextColor(Color.parseColor(colorNum));
        }
    }
    ...
    /**
     * 正在滑动，scaleOfLayout>=1表示头已滑出，可以刷新，scaleOfLayout<1头还滑出
     *
     * @param scaleOfLayout
     */
     ...
     * @param message
     */
    public final void resetComplete(String message) {
        if (null != message) {
