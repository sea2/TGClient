...
import com.tangguo.tangguoxianjin.util.ViewUtils;
...
public class TitleLayout extends LinearLayout {
    ...
    public void setHtmlClose(OnClickListener finish) {
        ...
        main_title_name.setMaxEms(getResources().getInteger(R.integer.title_em_size_show_close));
    }
    ...
    public void setSecondTitle(String title) {
        showTitleBar();
        if (title != null) {
            main_title_second_name.setVisibility(VISIBLE);
