 ...
 * @author yejingjie
 */
public class WeiXinRepayDialog extends Dialog {
    private View mView;
    ...
    public WeiXinRepayDialog(Context context) {
        super(context, R.style.commonDialog);
        setCanceledOnTouchOutside(false);
        setCancelable(true);
        mView = getLayoutInflater().inflate(R.layout.dialog_weixin_repay, null);
    ...
    public void setImage(Bitmap mBitmap) {
        if (mBitmap != null) {
            tv_show_img.setVisibility(View.VISIBLE);
            tv_show_img.setImageBitmap(mBitmap);
        }
    }
    ...
    private void initViews() {
        ...
        tv_show_img = (ImageView) findViewById(R.id.tv_show_img);
